...
public class WorldGenAusTree extends WorldGenerator
{
    ...
    public WorldGenAusTree(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public WorldGenAusTree(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
            ...
            else
            {
                ...
                if ((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && par4 < 256 - var6 - 1)
                {
                    ...
                    for (var11 = par4 - var9 + var6; var11 <= par4 + var6; ++var11)
                    {
                        ...
                        for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
                        {
                            ...
                            for (int var16 = par5 - var13; var16 <= par5 + var13; ++var16)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(par1World, var14, var11, var16, aussiecraft.gumLeaves.blockID, this.metaLeaves);
                                }
                            }
                        }
                    }
                    ...
                    for (var11 = 0; var11 < var6; ++var11)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + var11, par5, aussiecraft.gumLog.blockID, this.metaWood);
